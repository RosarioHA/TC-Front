...
const PasoUnoRevisionPostCid = () => {
  ...
  return (
    <>
      <div className="container">
        ...
        <div className="my-4 ">
          <RecomendacionTransferencia 
            regionesListado={regiones_recomendadas_listado} 
            regionesRecomendadas={regiones_recomendadas} 
            //solo_lectura={solo_lectura} 
          />
        </div>
      </div>
      ...
      <NavigationSubdere 
        step={paso1_revision_final_subdere.numero_paso} 
...
export default PasoUnoRevisionPostCid;