...
const PasoUno = () =>
{
  ...
  const { id, nombre_paso, avance, p_1_1_ficha_descripcion_organizacional,p_1_2_organizacion_institucional,organigramaregional_set,     p_1_3_marco_regulatorio_y_funcional_competencia, numero_paso } = pasoData;
  return (
    <>
