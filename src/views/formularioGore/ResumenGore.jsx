...
const ResumenGore = () =>
{
  ...
  const { id } = useParams();
  const { resumen, actualizarFormularioEnviado, subirArchivo, guardarDescripcion, eliminarArchivo } = useResumenGore(id);
  ...
  const handleFileSelect = async (file) =>
  {
    try
    {
      await subirArchivo(file, "antecedente_adicional_gore");
    } catch (error)
    {
