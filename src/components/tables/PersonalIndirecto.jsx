...
const PersonalIndirecto = ({
  ...
  const agregarNuevaCalidadJuridica = async (calidadJuridicaSeleccionada, labelSeleccionado) => {
    ...
    try {
      ...
      if (response && response.data.p_5_3_b_personal_indirecto) {
        const listaActualizadaPersonal = response.data.p_5_3_b_personal_indirecto;
    ...
    <div className="my-4">
          ...
          {Object.entries(personas).map(([calidad_juridica, personas], index) => (
            <div key={index}>
              ...
              <div className="row mt-3">
                ...
                <div className="col-2"> <p className="text-sans-p-bold">Estamento</p> </div>
                ...
                if (itemCorrespondiente) {
                  return (
                    <div key={itemIndex} className="my-4">
                      <p className="text-sans-p-bold">Resumen de justificación de costos de personal de soporte: {item.label}</p>
                      <h6 className="text-sans-h6-primary mt-3">Debes justificar el 100% del costo informado en el punto 5.1b para completar esta sección.</h6>
      ...
      <div className="mt-5">
        <Controller
          ...
          defaultValue={paso5.descripcion_funciones_personal_indirecto || ''}
          render={({ field }) => {
            // Destructura las propiedades necesarias de field
            const { onChange, onBlur, value } = field;
            ...
            return (
              <CustomTextarea
                id={`descripcion_funciones_personal_indirecto`}
