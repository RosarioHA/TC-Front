...
export const IndicadoresDesempeno = () => {
    ...
    // Función para eliminar una sección por su índice
    ...
    <>
        <div key={index} className="mx-1 border row mb-3">
            <div className="border-end col-1 p-3">{index + 1}</div>
        ...
        <div className="d-flex justify-content-end">
            <button className="btn-terciario mb-4" onClick={() => eliminarSeccion(index)}>
                <i className="material-symbols-rounded me-2">delete</i>
                <p className="mb-0 text-decoration-underline">Eliminar Indicador</p>
            </button>
        </div>
        )}
    </> 
    ...
    return (
      <div className="mb-4 col-11">
        <h4 className="text-sans-h4 my-3">4.5a Indicadores de desempeño</h4>
  
        {/* Renderizar todas las secciones */}
        {secciones.map((_, index) => renderSeccion(index))}
