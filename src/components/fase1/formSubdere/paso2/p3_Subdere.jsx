          ...
          <>
            ...
            <div className="mb-4 col-11">
              <div className="container-fluid">
                {recomendaciones_desfavorables.sort((a, b) => a.region - b.region).map((region, index) => (
                  <React.Fragment key={index}>
                    <div className="col d-flex flex-column justify-content-between my-3 col-10" key={region.id}>
                      ...
                      <div className="mx-2">
                        <CustomTextarea
                          ...
                          onChange={(e) => handleUpdate(region.id, 'justificacion', e.target.value)} // Actualizado para manejar cambios inmediatos
