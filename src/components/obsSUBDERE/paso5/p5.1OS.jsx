...
export const Subpaso_CincoPuntoUnoOS = () => {
  ...
  return (
    <div className="mt-4 me-5 pe-5">
      ...
      <div >
        <Costos 
        readOnly={true}
        //aqui se manda 'activo' o 'inactivo' para mostrar la alternativa 'si' o 'no' en RadioButtons
        esTransversal='activo'/> 
        <hr />
      </div>
