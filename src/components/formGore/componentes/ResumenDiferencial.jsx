      ...
      <div className="pe-5 me-5 mt-4 col-11">
        <div className="subrayado col-12">
          <div className="align-self-center text-sans-h4">
            Resumen de diferencial de costos con la información entregada por el
            sector
          </div>
        </div>
        <div className="text-sans-h6-primary my-3 col-11">
          <h6>
            Solo podrás continuar cuando tengas 0 costos por justificar. Es
            decir, hayas justificado todas las diferencias presupuestarias con
            el sector.
          </h6>
        </div>
        <div>
          <table className="table table-secondary my-4">
            ...
            <tbody>
              <tr className="table-light text-center py-5 " key="">
                ...
                <td className="py-3">
                  <span className="text-sans-p-bold-blue pe-5">{informada || 0}  </span>
                </td>
                <td className="py-3">
                  <span className="text-sans-p-bold-blue pe-5">{justificados || 0}</span>
                </td>
                <td className="py-3">
                  <span className="text-sans-p-bold-blue pe-5">{justificar || 0}</span>
                </td>
              </tr>
            </tbody>
          </table>
