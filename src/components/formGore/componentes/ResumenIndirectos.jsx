                ...
                <tr className="table-light text-center py-5 " key={item.id}>
                  ...
                  <td className="py-3">
                    <span className="text-sans-p-bold-blue pe-5">
                      $ {Number(item.indirectos_por_sector).toLocaleString('es-CL')}
                    </span>
                  </td>
                  <td className="py-3">
                    <span className="text-sans-p-bold-blue pe-5">
                      $ {Number(item.indirectos_por_gore).toLocaleString('es-CL')}
                    </span>
                  </td>
                  <td className="py-3">
                    <span className="text-sans-p-bold-blue pe-5">
                      $ {Number(item.diferencia_indirectos).toLocaleString('es-CL')}
                    </span>
                  </td>
                </tr>
              ))}
